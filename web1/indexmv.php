...
<html>
	<head>
    <link href="estilo/estilomv.css" media="screen" type="text/css" rel="stylesheet">
		<link href="estilo/estilo2.css" media="screen" type="text/css" rel="stylesheet">
		<?php
...
<?php
 ...
 <div class="fondo">
 									...
 									<form action="indexmv.php" method="get">
 										<div class="imag">
 										<img src="imagen/user.png" alt="x" class="imag">
 									  </div>
 ...
 <div class="CabecerayPie">
	 <?php
	            ...
	            $id_encode = base64_encode($id);
	             ...
	             $id=$row['Idnoticia'];
	             $id_encode= base64_encode($id);
	 									echo "<div class='CabecerayPie'> <a href='mostrarnoticia.php?id=" . urlencode($id_encode) . "'>";
